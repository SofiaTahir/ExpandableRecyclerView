...
public abstract class ExpandableRecyclerAdapter<PVH extends ParentViewHolder, CVH extends ChildViewHolder, HVH extends ChildViewHolder>
    ...
    private List<? extends HeadingListItem> mHeadingItemList;
     ...
     */
    public ExpandableRecyclerAdapter(List<? extends HeadingListItem> headingListItems) {
        super();
        mHeadingItemList = headingListItems;
        mItemList = ExpandableRecyclerAdapterHelper.generateHeadingParentItemList(mHeadingItemList);
        //mParentItemList = (List<? extends ParentListItem>) headingListItemsItemList.getChildItemList();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        if (viewType == TYPE_PARENT) {
            ...
            return onCreateHeadingViewHolder(viewGroup);
        }else {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        } else if(listItem instanceof HeaderWrapper){
            HeaderWrapper headerWrapper = (HeaderWrapper) listItem;
            onBindHeadingViewHolder((HVH) holder, position, headerWrapper.getHeaderListItem());
        }else {
    ...
    public abstract HVH onCreateHeadingViewHolder(ViewGroup headingViewGroup);
    ...
    public abstract void onBindHeadingViewHolder(HVH headingViewHolder, int position, Object HeadingListItem);
